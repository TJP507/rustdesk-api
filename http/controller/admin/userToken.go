...
// List List
// @Tags UserToken
// @Summary Login token list
// @Description Login token list
// @Accept  json
// @Produce  json
...
// @Description Delete login token
// @Accept  json
// @Produce  json
// @Param body body model.UserToken true "Login token information"
...
// @Tags UserToken
// @Summary Batch delete login tokens
// @Description Batch delete login tokens
// @Accept  json
// @Produce  json
// @Param body body admin.UserTokenBatchDeleteForm true "Login token information"
// @Success 200 {object} response.Response
// @Failure 500 {object} response.Response
